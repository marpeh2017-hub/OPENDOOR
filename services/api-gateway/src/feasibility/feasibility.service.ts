  ...
  async upsertFinancing(projectId: string, scenarioId: string, dto: UpsertFeasibilityFinancingDto, actor: AuditActor) {
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      const row = await tx.feasibilityFinancingAssumption.upsert({
        where: { scenarioId },
        create: { scenarioId, debtAmount: decimal(dto.debtAmount), equityAmount: decimal(dto.equityAmount), ltc: decimal(dto.ltc), ltv: decimal(dto.ltv), annualInterestRate: decimal(dto.annualInterestRate), arrangementFeeRate: decimal(dto.arrangementFeeRate), guaranteeFeeRate: decimal(dto.guaranteeFeeRate), graceMonths: dto.graceMonths, financingMonths: dto.financingMonths, equitySource: dto.equitySource, equityBalanceFloor: decimal(dto.equityBalanceFloor), classification: dto.classification, confidence: dto.confidence, isVerified: dto.isVerified, sourceId: dto.sourceId, sourceDate: date(dto.sourceDate), notes: dto.notes, createdById: actor.userId, updatedById: actor.userId },
        update: { debtAmount: decimal(dto.debtAmount), equityAmount: decimal(dto.equityAmount), ltc: decimal(dto.ltc), ltv: decimal(dto.ltv), annualInterestRate: decimal(dto.annualInterestRate), arrangementFeeRate: decimal(dto.arrangementFeeRate), guaranteeFeeRate: decimal(dto.guaranteeFeeRate), graceMonths: dto.graceMonths, financingMonths: dto.financingMonths, equitySource: dto.equitySource, equityBalanceFloor: decimal(dto.equityBalanceFloor), classification: dto.classification, confidence: dto.confidence, isVerified: dto.isVerified, sourceId: dto.sourceId, sourceDate: date(dto.sourceDate), notes: dto.notes, updatedById: actor.userId },
      })
