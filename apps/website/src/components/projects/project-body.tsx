...
import { galleryItems, hasProjectFacts, oldestVerification } from '@/lib/project-presentation'
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 pb-10 pt-8 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:gap-14">
            <div>
              ...
              <h1
                className={`${project.type ? 'mt-3.5' : ''} text-4xl font-extrabold leading-[1.06] tracking-tight text-gray-900 sm:text-5xl`}
              >
                {t.text(project.name)}
              </h1>
                ...
                <dl className="mt-6 flex flex-wrap gap-x-7 gap-y-2 text-[15px]">
                  ...
                  {project.location.street && (
                    <div className="flex gap-2">
                      ...
                      <dd className="m-0 font-semibold text-gray-800">{project.location.street}</dd>
                    </div>
                  )}
                </dl>
              )}
      ...
      <Section tone="inverse" size="lg">
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
          ...
          <div>
            {role ? (
              <p className="text-base leading-relaxed text-gray-300 sm:text-[17px]">{role}</p>
            ) : (
              <>
      ...
      {milestones.length > 0 && (
        <Section tone="raised" size="lg">
          ...
          <MilestoneList verifiedProjection={verifiedProjection} milestones={milestones} t={t} />
        </Section>
      )}
      ...
      {facts ? (
        <Section size="lg">
          <SectionHead eyebrow={tSections('factsEyebrow')} heading={tSections('factsHeading')} />
...
function SectionHead({
  ...
  return (
    <div>
      ...
      />
      {intro && <p className="mt-6 max-w-prose text-base leading-relaxed text-gray-600">{intro}</p>}
    </div>
  )
}
